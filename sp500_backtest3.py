# -*- coding: cp1252 -*-
# generated by GPT. Start year behaviour is not correct.
# run from prompt: streamlit run sp500_backtest.py
# backtest3.py user choice of FTSE vs S&P500.
#
...
# Input from the user
index_choice = st.selectbox("Select Index:", options=["S&P 500", "FTSE 100"])
...
ticker_symbol = "^GSPC" if index_choice == "S&P 500" else "^FTSE"
...
def monte_carlo_simulation(data, initial_amount, years, num_simulations=100):
    ...
    for _ in range(num_simulations):
        ...
        for _ in range(days):
            ...
            # Replace any negative value with 1
