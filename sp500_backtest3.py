...
choice_dict = {
    ...
    "BH_select": 'VOD.L CURY.L BARC.L LAND.L CRST.L NWG.L HSBA.L BATS.L SQZ.L TW.L S32.L PSN.L SHEL.L MNG.L VTY.L FRES.L o PRU.L AV.L TSCO.L SSE.L CNA.L SDLF.L RIO.L FRES.L PNN.L GFRD.L IMB.L LGEN.L IAG.L KGF.L DOCS.L EZJ.L MTRO.L UTG.L HLN.L CTEC.L BTRW.L',
    "BH_T":'CHG.L DSCV.L MRO.L SNR.L SPX.L WEIR.L ATYM.L HOC.L TCAP.L VCT.L TBCG.L DDOG VICI FSLR HPE KHC IVZ OMC TER AMCR FDS CEG',
...
def main():
    ...
    stock_choice = st.selectbox(
        "Select Stocks:", 
        options=["manual symbols","ISA", "SIPP", "airlines", "banks", "builders","BH_select", "BH_T", "Real Estate ETFs", "Reits","US_stocks"]
    )
